...
const player_service_1 = require("../Concrete/player.service");
const player_entity_1 = require("src/Entity/Models/player.entity");
const player_controller_1 = require("src/Http/Controllers/player.controller");
...
exports.PlayerModule = PlayerModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [player_service_1.PlayerService, player_entity_1.Player],
    })
], PlayerModule);
